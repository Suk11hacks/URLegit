...
# Set your remote model URL here (optional)
MODEL_URL = "https://github.com/yourusername/malicious-url-app/raw/main/model/rf_url_model.pkl"
...
def load_model():
    try:
        ...
        st.warning("⚠️ Could not load model from URL. Upload a model file manually.")
        return None
